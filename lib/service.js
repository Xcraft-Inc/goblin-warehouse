...
const updateSubscriptions = (state, {owners, newOwners, branch}, nested) => {
  ...
  for (const feed of feeds) {
    ...
    checkList
      ...
      .forEach(
        id => (state = state.set(`_subscriptions.${feed}.branches.${id}`, true))
      );
  }
...
const logicHandlers = {
  ...
  'update-subscriptions': (state, action) => {
    ...
    return updateSubscriptions(state, {owners, newOwners, branch}, true);
  },
